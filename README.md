...
delta-trade-spread-gate is a Zig project for trading systems. It focuses on this technical goal: Design a Zig verification harness for spread systems, covering security rule linting, safe and unsafe fixtures, and failure-oriented tests.
