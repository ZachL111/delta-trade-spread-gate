"""Regression checks for the delta-trade-spread-gate casebook."""
...
from casebook.harness import assert_expected, delta_trade_spread_gate_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(delta_trade_spread_gate_summary(), assert_expected())
